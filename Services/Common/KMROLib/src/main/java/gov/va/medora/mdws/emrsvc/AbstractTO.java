...
@XmlSeeAlso({
    MentalHealthInstrumentResultSetTO.class,
    TextTO.class,
    SiteTO.class,
    ReminderReportPatientListTO.class,
    TaggedText.class,
    RegionTO.class,
    UserTO.class,
    NoteResultTO.class,
    ...
    CytologyRpt.class,
    UserSecurityKeyTO.class,
    AppointmentTO.class,
    LabTestTO.class,
    PatientListEntryTO.class,
    LabResultTO.class,
    OrderDialogItemTO.class,
    AdtTO.class,
    ...
    PhoneNumTO.class,
    MedicationTO.class,
    MentalHealthInstrumentAdministrationTO.class,
    VitalSignTO.class,
